...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/61cc030a-051e-4445-95fa-7f9042be46a0" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-blue-500 text-gray-300'>Contact</p>
                <p className='text-gray-300 py-4'>Let's get in touch! Submit the form below or email me at okigenc1234@gmail.com</p>
            </div>
